...
from youckan.apps.sso.mail import send_confirmation
from youckan.apps.sso.backends import NoSocialAuth
...
def fix_no_social_auth(strategy, backend, details, user, response, *args, **kwargs):
    if isinstance(backend, NoSocialAuth):
