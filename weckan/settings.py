# -*- coding: utf-8 -*-
# Django settings for weckan project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'weckan.sqlite',                      # Or path to database file if using sqlite3.
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'weckan.context_processors.etalab_config',
)

JS_CONTEXT_PROCESSOR = 'weckan.context_serializer.WeckanContextSerializer'
...
AUTH_USER_MODEL = 'auth.WeckanUser'
...
AUTHENTICATION_BACKENDS = (
    ...
    'weckan.auth.backends.NoSocialAuth',
...
SOCIAL_AUTH_EMAIL_VALIDATION_FUNCTION = 'weckan.auth.mail.send_validation'
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'weckan.auth.pipeline.new_registeration_only',
    'social.pipeline.user.get_username',
    # 'social.pipeline.user.create_user',
    # 'social.pipeline.social_auth.load_extra_data',
    # 'social.pipeline.user.user_details'
    'weckan.auth.pipeline.get_avatar_url',
    'weckan.auth.pipeline.register_form',
    'social.pipeline.mail.mail_validation',
    'social.pipeline.social_auth.associate_user',
    'weckan.auth.pipeline.fetch_avatar',
    'weckan.auth.pipeline.activate_user',
)

ROOT_URLCONF = 'weckan.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'weckan.wsgi.application'
...
PIPELINE_JS = {
    ...
    'weckan-common': {
        ...
        'output_filename': 'js/weckan.min.js'
    },
    'home': {
        'source_filenames': (
            'js/home.js'
